...
Module["cwrap"] = cwrap;
var _compileLaTeX, _compileFormat, _compileBibtex, _setMainEntry, _main, _emscripten_builtin_memalign, _setThrew, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, memory, __indirect_function_table, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
    _compileLaTeX = Module["_compileLaTeX"] = wasmExports["L"];
    _compileFormat = Module["_compileFormat"] = wasmExports["M"];
    _compileBibtex = Module["_compileBibtex"] = wasmExports["N"];
    _setMainEntry = Module["_setMainEntry"] = wasmExports["O"];
    _main = Module["_main"] = wasmExports["P"];
    _emscripten_builtin_memalign = wasmExports["R"];
...
var wasmImports = {
    j: ___assert_fail,
    E: ___syscall_faccessat,
    l: ___syscall_fcntl64,
    D: ___syscall_fstat64,
    z: ___syscall_getcwd,
    H: ___syscall_ioctl,
    A: ___syscall_lstat64,
    B: ___syscall_newfstatat,
    m: ___syscall_openat,
    C: ___syscall_stat64,
    F: __abort_js,
    q: __emscripten_throw_longjmp,
    v: __localtime_js,
    t: __mmap_js,
    u: __munmap_js,
    G: __tzset_js,
